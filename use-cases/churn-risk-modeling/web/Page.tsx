  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.6fr_1fr]">
      <section className="rounded-lg border border-hairline bg-ink-800 p-8">
        ...
        <p className="mt-4 max-w-[70ch] leading-relaxed text-fog-300">
          Publishes <code className="font-mono text-sm text-ivory-100">churn_risk</code>,{" "}
          <code className="font-mono text-sm text-ivory-100">churn_band</code>, and{" "}
          <code className="font-mono text-sm text-ivory-100">expected_days_to_visit</code>{" "}
