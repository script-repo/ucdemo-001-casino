 ...
 * label stays charcoal for contrast on the light tinted pill, and the colour is
...
export function StatusBadge({ status }: { status: UseCaseStatus }) {
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold text-charcoal-900 ${style.tint}`}
    >
